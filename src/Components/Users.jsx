              ...
              users.map((usr,i)=>{
                return(
                  <tr key={i}>
                    ...
                    <td>{usr.password}</td>
                    <td>
                      <button type="button" className="btn btn-warning" onClick={()=>handleEdit(usr,i)}>edit</button>
                    </td>
                    <td>
                      <button type="button" className='btn btn-danger' onClick={()=>handleDelete(usr,i)}>delete</button>
                    </td>
                  </tr>
                )
              })
